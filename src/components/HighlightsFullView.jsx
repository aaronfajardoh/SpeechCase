...
const HighlightsFullView = ({ highlightItems, setHighlightItems, documentId, highlights, onColorChange, onDelete, pdfFileName, onMinimize, summaryText: externalSummaryText, onSummaryGenerated }) => {
...
${htmlContent}
  ...
  return (
    <div className="highlights-full-view">
      ...
      <div className="highlights-full-view-content highlights-editor-full-view">
