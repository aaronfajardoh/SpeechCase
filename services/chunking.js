 ...
 * @returns {Array<Object>} Chunks with added metadata tags
 */
export function addMetadataTags(chunks, fullText) {
 ...
 * @returns {Array<Object>} Array of exhibit objects with name, number, and position
 */
